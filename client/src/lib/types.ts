...
export interface SessionUser {
  ...
  parent?: {
    ...
    children: {
      ...
      admissionNumber: string;
      user: { name: string };
      classRoom?: { name: string; stream: string } | null;
    }[];
  };
}
...
export interface SchoolSettings extends SchoolPublicInfo {
...
export interface MarksImportError {
  row: number;
  admissionNumber: string;
  component: string;
  reason: string;
