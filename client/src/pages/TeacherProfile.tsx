    ...
    return (
      <div className="card">
        <EmptyState
          ...
          hint={error ?? 'This teacher may have been removed.'}
          icon="users"
        />
  ...
  return (
    <div>
      <button
        ...
        onClick={() => navigate(self ? '/' : '/teachers')}
      >
          ...
          <div className="card overflow-hidden">
            <div className="border-b border-slate-200 px-5 py-3.5 dark:border-slate-800">
              ...
              <p className="text-xs text-slate-400">
                Subject and class combinations this teacher is responsible for.
              </p>
            </div>
            {teacher.assignments.length === 0 ? (
              <EmptyState
                title="No assignments yet"
                hint="Assign subjects and classes from the Teachers page."
                icon="book"
              />
            ) : (
                  ...
                  <tbody>
                    {teacher.assignments.map((a) => (
                      ...
                      >
                        ...
                        <td className="td">
                          {a.classRoom.name} {a.classRoom.stream}
                        </td>
