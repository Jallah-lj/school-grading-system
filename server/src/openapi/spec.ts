          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  name: { type: 'string', example: 'Kigali Secondary School' },
                  motto: { type: 'string', example: '' },
                  hasBadge: { type: 'boolean', example: true },
                  academicYear: { type: 'string', nullable: true, example: '2024-2025' },
                },
              },
              example: { name: 'Kigali Secondary School', motto: '', hasBadge: true, academicYear: '2024-2025' },
            },
          },
        },
      },
        ...
        200: {
          ...
          content: {
            'application/json': {
              ...
              example: { name: 'Kigali Secondary School', motto: '', studentIdPrefix: 'SGS', hasBadge: true, updatedAt: '2025-01-10T12:00:00Z' },
            },
          },
        },
      }),
